    ...
    public static class Builder {
        ...
        public Builder preferedSimilarityMeasure(String similarityMeasure) { // TODO fix hard coding
            if (!similarityMeasure.equals(Torch.Algorithms.DTW) &&
                ...
                throw new IllegalArgumentException("checkout supported index type options at Torch.Algorithms");
            }
        ...
        public Builder addQuery(String queryType) {
            if (!queryType.equals(Torch.QueryType.PathQ) &&
                ...
                throw new IllegalArgumentException("checkout supported query type options at Torch.QueryType");
            }
